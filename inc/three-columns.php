<?php 
/**
 * three column archive display
 * used on all archives if three-column display is selected
 * @package codon
 */
 ?>
		...
		<div id="content">
			<?php
				if ( is_front_page() ) {
					...
					?>
			<?php if (have_posts()) : ?>
				<ul class="small-block-grid-1 medium-block-grid-2 large-block-grid-3 column-posts main-content-area">
